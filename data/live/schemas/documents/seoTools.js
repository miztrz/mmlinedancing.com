import seo-tools from '../../node_modules/sanity-plugin-seo-tools/lib/schema/index',
...
export default {
    ...
    fields: [{
        ...
        options: {
            baseUrl: 'https://mmlinedancing.com/',
            baseUrl(doc) {
                return 'https://mmlinedancing.com/'; // for dynamic baseUrls
            },
